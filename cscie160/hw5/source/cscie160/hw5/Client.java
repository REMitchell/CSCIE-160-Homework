...
//Client cannot get exceptions "across the wire" -- this is why we need unit tests
//For every part of the code

//This calls the proxy
public class Client {
   public static void main(String[] args) {
      ...
      if (atm!=null) {
         try {
            ...
            System.out.println("Depositing(0000001): 1000 ");
            ...
            System.out.println("Depositing(0000003): 500 ");
            ...
            re.printStackTrace();
         } catch (ATMException f) {
        	 //Added by Ryan Mitchell. Needed to handle ATMException
        	 System.out.println("ATMException");
        	 f.printStackTrace();
         }
      }
   }
